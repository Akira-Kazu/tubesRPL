...
public class BimbinganJdbc implements BimbinganRepository {
    ...
    private Bimbingan mapRowToBimbingan(ResultSet rs, int rowNum) throws SQLException {
        ...
        b.setIdBim(rs.getString("IdBim"));
        b.setTopikBim(rs.getString("TopikBim"));
        b.setDeskripsiBim(rs.getString("DeskripsiBim"));
        b.setNamaRuangan(rs.getString("namaRuangan"));
        b.setNamaDosen(rs.getString("namaDosen"));
